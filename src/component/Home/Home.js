...
function Home() {
  ...
  return (
    <div>
      ...
      <section className="container">
        <div className="leftright">
          <div className="left">
            ...
            <div className="bgshape"><img src="./Assest/bgshape/shape4.png" alt="" /></div>
      ...
      <section className="container">
        <span className="heading educationh">Eduction</span>
        <div className="second_lfri">
          ...
          <div className="second_right" >
            <div className="collage" style={{ display: div ? "block" : "none", width: "500px", margin: "25px" }}>
            ...
            <div style={{ display: div ? "none" : "block", width: "500px", margin: "25px" }}> <div className="text">
              <span className="heading">Eduction</span>
              <div className="collage_name" >
      ...
      <section className="container">
        <span className="heading">Experince</span>
        <div className="third">
      ...
      <section className="container">
        <div className="forth">
          <div className="portfolio_header">
            <span className="heading my_project_h" >My Projects</span>
      ...
      <section className="container" ref={myRef}>
        <span className="heading git_t">GET IN TOUCH</span>
          ...
          <div className="left">
            ...
            <div className="details">
              <div className="backbox">
                ...
                <div className="p_3 whitebox">

                  <img src="./Assest/bioicon/mail.png" alt="" />
                  <span>jemishviradiya9@gmail.com</span>
                </div>
                <div className="p_4 whitebox">
                  <span>Social</span>
                  <ul>
                    <li>
